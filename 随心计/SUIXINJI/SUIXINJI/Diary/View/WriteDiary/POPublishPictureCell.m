//
//  POPublishPictureCell.m
//  AFNetworking
//
//  Created by nuomi on 2018/5/22.
//
...
- (void)awakeFromNib {
    [super awakeFromNib];
//    self.bgScrollviewHeight.constant = PictureSize+10;
}
...
//    if (self.realImageModes.count<4) {
//        self.bgPictureScrollview.contentSize = CGSizeMake(ScreenWidth-30, 30+((self.realImageModes.count+1)/2)*(PictureSize+10));
//    } else {
//        self.bgPictureScrollview.contentSize = CGSizeMake(19+(PictureSize + 10)*5, 30+((self.realImageModes.count+1)/2)*(PictureSize+10));
//    }
