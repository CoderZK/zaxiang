...
- (void)setDefaultValues{
    ...
    self.weekDayFormat = LTSCalendarWeekDayFormatShort;
    self.weekDayTextFont = [UIFont systemFontOfSize:12];
     self.weekDayTextColor = [UIColor colorWithRed:119./256. green:124./256. blue:181./256. alpha:1.];
    self.weeksToDisplay = 5;
    ...
    self.dayBorderColorToday = SMColorFromRGB(0x777CB5);
    self.dayCircleColorSelected  = SMColorFromRGB(0x777CB5);
    self.dayCircleColorToday  = SMColorFromRGB(0x777CB5);
    self.dayTextColorToday = [UIColor whiteColor];
    self.dayDotColor = [UIColor clearColor];
