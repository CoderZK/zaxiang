...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    JSFastLoginModel * model = self.dataArr[indexPath.row];
    WS(wSelf);
    [[JSSelectViewTool sharedManager] inpour:[NSMutableArray arrayWithObjects:@"恢复",@"彻底删除", nil] currentIndexd:0 confirmBlock:^(id obj, NSInteger currentIndex) {
